...
var init_util = __esm({
  "src/util.ts"() {
    ...
    _getParamsForAppAccessibility = (commandName, testName) => {
      return {
    ...
    getAppA11yResults = PerformanceTester.measureWrapper(A11Y_EVENTS.GET_RESULTS, async (isAppAutomate, browser, testName, isBrowserStackSession, isAccessibility, sessionId) => {
    ...
    getAppA11yResultsSummary = PerformanceTester.measureWrapper(A11Y_EVENTS.GET_RESULTS_SUMMARY, async (isAppAutomate, browser, testName, isBrowserStackSession, isAccessibility, sessionId) => {
      if (!isBrowserStackSession) {
        return {};
      }
      if (!isAppAccessibilityAutomationSession(isAccessibility, isAppAutomate)) {
      ...
      async onBeforeExecute() {
        try {
          ...
          browser.getAccessibilityResultsSummary = async () => {
            if (this.isAppAccessibility) {
              return await getAppA11yResultsSummary(true, browser, this.currentTestName, isBrowserstackSession2, this.accessibility, sessionId);
            }
            return await this.getA11yResultsSummary(browser);
          };
          browser.getAccessibilityResults = async () => {
            if (this.isAppAccessibility) {
              return await getAppA11yResults(true, browser, this.currentTestName, isBrowserstackSession2, this.accessibility, sessionId);
            }
        ...
        return await PerformanceTester.measureWrapper(
          ...
          async () => {
            try {
              ...
              if (this.isAppAccessibility) {
                const testName = this.currentTestName || void 0;
...
async function sendFinish(config, isCLIEnabled = false) {
...
function shouldCallCleanup(config, isCLIEnabled = false) {
  const args = [];
